...
def main_helper(filename, data_folder):
    ...
    low_output_filepath = data_folder[:-7] + "Output8/" + filename[:-4] + "-lowset.txt"
    ...
    high_output_filepath = data_folder[:-7] + "Output8/" + filename[:-4] + "-highset.txt"
    ...
    voc_output_filepath = data_folder[:-7] + "Output8/" + filename[:-4] + "-voc.txt"
    ...
    final_output_filepath = data_folder[:-7] + "Output8/" + filename[:-4] + "-done.txt"
